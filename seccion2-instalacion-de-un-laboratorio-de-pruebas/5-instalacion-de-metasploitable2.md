# 5. Instalación de metasploitable2
...
* Vamos al resultado de la página de **SourceForge** (link en la sección **Recursos**)
...
[Link de instalacion](https://sourceforge.net/projects/metasploitable/files/Metasploitable2/)